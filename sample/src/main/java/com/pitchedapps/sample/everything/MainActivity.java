...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lrv.addLibCard("The Library of Everything can add essential features in a few lines", "This is something I built for myself, and is tested extensively and hopefully fixes most bugs. Click me for another way to access the source code.", "asdfasdfvful (me :) )", "https://github.com/asdfasdfvful/The-Library-of-Everything");
